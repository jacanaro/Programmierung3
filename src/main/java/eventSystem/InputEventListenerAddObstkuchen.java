...
public class InputEventListenerAddObstkuchen implements InputEventListener {
    @Override
                ...
                if (userInputStrArr.length > 2) {
                    for (int i = 0; i < userInputStrArr.length; i++) {
                        if (userInputStrArr[i].equals("Obstkuchen")) {
                            ...
                            if(c.getMy_log()!=null)c.getMy_log().logger.info("es wird versucht, dem Automat ein Obstkuchen hinzuzufügen");
                            ...
                            if(automatErrorCodes==null && c.getMy_log()!=null)c.getMy_log().logger.info("Obstkuchen wurde hinzugefügt");
                        }
                    }
                }
            }
